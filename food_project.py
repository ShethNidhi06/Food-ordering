...
Label(root,text="Ayodhya Upahar",font="comicsanms 25 italic",fg="Red",padx=200,pady=10,
...
def totalbill():
    ...
    total.set((food1*10)+(food2*10)+(food3*15)+(food3*15)+(food4*15)+(food5*20)+(food6*50)+(food7*30)+(food8*25)+(food9*35)+
